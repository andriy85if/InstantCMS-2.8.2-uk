<?php
    ...
    define('LANG_STEP_START_1',             'Майстер встановлення InstantCMS перевірить чи відповідає ваш сервер системним вимогам.');
    ...
    define('LANG_PHP_VERSION_REQ',          'Необхідно PHP 5.4 або вище');
	...
	define('LANG_PHP_VARIABLES_ON',			'Увімк.');
	define('LANG_PHP_VARIABLES_OFF',		'Вимк.');
    ...
    define('LANG_DATABASE_PREFIX_ERROR',    'Префікс БД може містити тільки латинські букви, цифри і знак підкреслення');
    ...
    define('LANG_DATABASE_ENGINE_NO',       'Обраний рушій БД не підтримується');
    define('LANG_DATABASE_ENGINE_DISABLED', 'Обраний рушій БД підтримується, але вимкнений в налаштуваннях MySQL');
    define('LANG_DATABASE_ENGINE_ERROR',    'Обраний рушій БД не підтримується сервером');
    ...
    define('LANG_CRON_EXAMPLE',             'Як правило, команда, котру необхідно додати до планувальника, виглядає так:');
